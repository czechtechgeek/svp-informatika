...
Žáci zapíší: jaký vyhledávač používají nejčastěji a proč.

## 📂 Podklady

- **Google Advanced Search:** [google.com/advanced_search](https://www.google.com/advanced_search) — formulář pro pokročilé vyhledávání bez znalosti operátorů
- **Ověřování zdrojů:** [Manipulátoři.cz](https://www.manipulatori.cz) — česká databáze dezinformačních webů
- **Průvodce vyhledáváním:** Knihovny.cz — tipy na efektivní vyhledávání v češtině
