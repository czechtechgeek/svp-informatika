...
Učitel krátce představí, co přijde v 7. ročníku:
- Modelování a diagramy
- Podmínky a proměnné ve Scratchi
- Sítě, cloudové služby, HTML
...
- **Google Drive organizace:** [support.google.com/drive](https://support.google.com/drive) — nápověda ke správě souborů a složek v češtině
- **Zpětnovazební formulář:** Připravte Google Formulář s otázkami reflexe — výsledky pomohou plánovat 7. ročník
- **Dopis do budoucna:** [futureme.org](https://www.futureme.org) — služba pro zasílání e-mailů do budoucna (lze použít pro starší žáky)
