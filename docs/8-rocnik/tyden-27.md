...
Klíčová sdělení:
- 3D model je popis tvaru v počítači (souřadnice X, Y, Z)
- Tinkercad je zdarma, funguje v prohlížeči, nevyžaduje instalaci
- Výstupy lze tisknout na 3D tiskárně nebo exportovat do her a animací
...
- Panel tvarů vpravo (Shape panel)
- Navigační kostka (View Cube) v rohu
...
- Jak objekt **přesunout** (kliknout a táhnout, nebo šipky na klávesnici)
...
* **Pracovní list:** Navigace v Tinkercad — sada 5 úkolů (orbit, zoom, umístění tvarů, změna barvy, uložení)
* **Inspirace:** Galerie Tinkercad (tinkercad.com/things) — ukázky projektů od jiných žáků
